 ...
 *
 * Icons are consumed by name (`<Icon name="close" />`), never by
 ...
 * "menu" for the mobile navigation toggle. An unused "arrow-right"
 * entry was removed in the Fase 7 audit for the same reason.
 *
